...
public class DetailPhieuNhapDialog extends javax.swing.JDialog {
    ...
    public DetailPhieuNhapDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public DetailPhieuNhapDialog(java.awt.Frame parent, boolean modal, List<ChiTietPhieuNhap> ctpn) {
        super(parent, modal);
        this.listCTPN = ctpn;
        initComponents();
        fillInput();
